		...
		switch (_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					speed_set(-10 * facing, -10, false, false);
			...
			case 1:
				...
				if (attack_frame == 32)
					{
					var _proj = hitbox_create_projectile_custom(obj_kapel, 24, -8, 1.3,1.3, 12, 13, 0.4, 65, 180, SHAPE.circle, 0, 0);
