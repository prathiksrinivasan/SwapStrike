...
function character_poly_init()
	...
	if (_set_properties)
		...
		//Hurtbox
		hurtbox_sprite = spr_poly_hurtbox;
	...
	if (_set_attacks)
		...
		my_attacks[$ "Taunt"		] = poly_taunt;
		my_attacks[$ "Final_Smash"	] = poly_final_smash;
		}
	...
	if (_set_sprites)
		...
		my_sprites[$ "Entrance"			] = anim_define(spr_poly_entrance, anim_define_ext(spr_poly_idle, 0, 0.09));
		my_sprites[$ "Idle"				] = anim_define_ext(spr_poly_idle, 0, 0.09);
		...
		my_sprites[$ "DJump_Rise"		] = anim_define(spr_poly_djump_rise, anim_define(spr_basic_jump_fall));
		my_sprites[$ "DJump_Mid"		] = -1;
		my_sprites[$ "DJump_Fall"		] = anim_define(spr_poly_djump_rise, anim_define(spr_basic_jump_fall));
		...
		my_sprites[$ "Shield_Release"	] = spr_poly_idle;
		...
		my_sprites[$ "Grabbing"			] = spr_poly_grabbing;
