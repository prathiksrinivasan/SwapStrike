...
/*
Creates an instance of <obj_vfx_color> with the given properties, and returns the id.
<obj_vfx_color> is essentially the same as <obj_vfx>, except it uses the palette of its owner.
*/
