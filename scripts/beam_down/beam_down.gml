			...
			case 0:
				{
					...
					if(attack_frame == 6){
						...
						var _hitbox = hitbox_create_melee(200,-27,5,1.3,4,8,1,3,-30,3,SHAPE.rotation,0);
						hitbox_sprite_angle_set(_hitbox,-30);
					}
					if(attack_frame == 3){
						anim_frame = 5;
						var _hitbox = hitbox_create_melee(253,-8,7.1,1.3,4,8,1,3,-30,3,SHAPE.rotation,1);
						hitbox_sprite_angle_set(_hitbox,-30);
					}
					if(attack_frame == 0){
						anim_frame = 6;
						var _hitbox = hitbox_create_melee(307, 21,9.1,1.3,12,8,1,3,-30,6,SHAPE.rotation,2);
						hitbox_sprite_angle_set(_hitbox,-30);
						attack_frame=25;
						attack_phase++;
					}
