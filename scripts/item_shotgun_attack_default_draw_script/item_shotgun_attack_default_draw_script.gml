function item_shotgun_attack_default_draw_script()
	{
	//Draw Script
	if (!variable_struct_exists(custom_attack_struct, "item_shotgun_frame"))
		{
		custom_attack_struct.item_shotgun_frame = 0;
		}
		
	//Draw onto the surface
	surface_set_target(object_surface_get());
	draw_clear_alpha(c_white, 0);
	draw_sprite_ext(spr_item_shotgun, custom_attack_struct.item_shotgun_frame, object_surface_size_half, object_surface_size_half, facing, 1, 0, c_white, 1);
