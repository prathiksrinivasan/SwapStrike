		...
		switch (_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					//Melee hit
					var _hitbox = hitbox_create_melee(32, 0, 0.6, 0.6, 8, 11, 0, 8, 0, 1.5, SHAPE.rotation, 0);
					...
					var _hitbox = hitbox_create_melee(32, 0, 0.6, 0.6, 8, 6, 0.5, 8, 50, 1.5, SHAPE.rotation, 0);
