		...
		switch (_phase)
			...
			case 1:
				...
				if (attack_frame == 25)
					...
					var _vfx = vfx_create_color(spr_samus_fair_burst, 1, 0, 20, x + lengthdir_x(_dist, _dir) * facing, y + lengthdir_y(_dist, _dir), 1.5, _dir);
					_vfx.important = true;
				...
				if (attack_frame == 3)
					...
					var _vfx = vfx_create_color(spr_samus_fair_burst, 1, 0, 20, x + lengthdir_x(_dist, _dir) * facing, y + lengthdir_y(_dist, _dir), 2, _dir);
					_vfx.important = true;
					_hitbox.hit_sfx = snd_hit_weak1;
