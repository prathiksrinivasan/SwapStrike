...
if (_s.explosion_time > 0)
	...
	if (_s.auto_explode_timer <= 0)
		...
		//Sweetspot
		var _hitbox = hitbox_create_melee(0, 0, 2, 2, 11, 7, 0.6, 11, 90, 10, SHAPE.circle, 0);
		_hitbox.hit_sfx = snd_hit_explosion3;
		_hitbox.hit_vfx_style = HIT_VFX.explosion;
		var _hitbox = hitbox_create_melee(0, 64, 1.5, 1.8, 11, 7, 0.6, 11, 90, 10, SHAPE.circle, 0);
		_hitbox.hit_sfx = snd_hit_explosion3;
		_hitbox.hit_vfx_style = HIT_VFX.explosion;
		var _hitbox = hitbox_create_melee(0, 128, 1.25, 1.5, 11, 7, 0.6, 11, 90, 10, SHAPE.circle, 0);
		_hitbox.hit_sfx = snd_hit_explosion3;
		_hitbox.hit_vfx_style = HIT_VFX.explosion;	
		//Weak hitbox
