...
if (_player != noone)
	{
	overlay_angle += clamp(angle_difference(point_direction(x, y, _player.x, _player.y), 90+overlay_angle), -_s.turn_speed, _s.turn_speed);
	}


hsp = lengthdir_x(_s.shoot_speed, 90+overlay_angle);
vsp = lengthdir_y(_s.shoot_speed, 90+overlay_angle);
